...
external init: unit -> ctx = "stub_whirlpool_init"
external update: ctx -> string -> int -> int -> unit = "stub_whirlpool_update"
external finalize: ctx -> t = "stub_whirlpool_finalize"
external to_hex: t -> string = "stub_whirlpool_to_hex"
external file_fast: string -> t = "stub_whirlpool_file"
