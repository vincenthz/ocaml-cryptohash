...
external init: unit -> ctx = "stub_skein512_init"
external update: ctx -> string -> int -> int -> unit = "stub_skein512_update"
external finalize: ctx -> t = "stub_skein512_finalize"
external to_hex: t -> string = "stub_skein512_to_hex"
external file_fast: string -> t = "stub_skein512_file"
