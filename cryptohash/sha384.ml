...
external init: unit -> ctx = "stub_sha384_init"
external update: ctx -> string -> int -> int -> unit = "stub_sha384_update"
external finalize: ctx -> t = "stub_sha384_finalize"
external to_hex: t -> string = "stub_sha384_to_hex"
external file_fast: string -> t = "stub_sha384_file"
