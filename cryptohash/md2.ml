...
external init: unit -> ctx = "stub_md2_init"
external update: ctx -> string -> int -> int -> unit = "stub_md2_update"
external finalize: ctx -> t = "stub_md2_finalize"
external to_hex: t -> string = "stub_md2_to_hex"
external file_fast: string -> t = "stub_md2_file"
