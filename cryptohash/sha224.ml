...
external init: unit -> ctx = "stub_sha224_init"
external update: ctx -> string -> int -> int -> unit = "stub_sha224_update"
external finalize: ctx -> t = "stub_sha224_finalize"
external to_hex: t -> string = "stub_sha224_to_hex"
external file_fast: string -> t = "stub_sha224_file"
