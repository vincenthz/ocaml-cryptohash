...
external init: unit -> ctx = "stub_sha3_init"
external update: ctx -> string -> int -> int -> unit = "stub_sha3_update"
external finalize: ctx -> t = "stub_sha3_finalize"
external to_hex: t -> string = "stub_sha3_to_hex"
external file_fast: string -> t = "stub_sha3_file"
