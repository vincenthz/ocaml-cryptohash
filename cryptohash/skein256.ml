...
external init: unit -> ctx = "stub_skein256_init"
external update: ctx -> string -> int -> int -> unit = "stub_skein256_update"
external finalize: ctx -> t = "stub_skein256_finalize"
external to_hex: t -> string = "stub_skein256_to_hex"
external file_fast: string -> t = "stub_skein256_file"
