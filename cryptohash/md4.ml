...
external init: unit -> ctx = "stub_md4_init"
external update: ctx -> string -> int -> int -> unit = "stub_md4_update"
external finalize: ctx -> t = "stub_md4_finalize"
external to_hex: t -> string = "stub_md4_to_hex"
external file_fast: string -> t = "stub_md4_file"
