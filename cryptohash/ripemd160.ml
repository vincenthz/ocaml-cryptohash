...
external init: unit -> ctx = "stub_ripemd160_init"
external update: ctx -> string -> int -> int -> unit = "stub_ripemd160_update"
external finalize: ctx -> t = "stub_ripemd160_finalize"
external to_hex: t -> string = "stub_ripemd160_to_hex"
external file_fast: string -> t = "stub_ripemd160_file"
