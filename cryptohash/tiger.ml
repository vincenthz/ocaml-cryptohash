...
external init: unit -> ctx = "stub_tiger_init"
external update: ctx -> string -> int -> int -> unit = "stub_tiger_update"
external finalize: ctx -> t = "stub_tiger_finalize"
external to_hex: t -> string = "stub_tiger_to_hex"
external file_fast: string -> t = "stub_tiger_file"
